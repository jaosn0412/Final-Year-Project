        ...
        <form action="update_data_admin_edit_lecturer_info.php?id=<?php echo $row['lecturer_ID']; ?>" method="post" onsubmit="return validate_form()">
            <div class="form-container">
                ...
                <div class="form-box1">
                    ...
                    <input type="text" name="edit_lecturer_focus" placeholder="Course Focus On" required="required" value="<?php echo $row["lecturer_course"]; ?>"><br><br>
                </div>

                <div class="form-box1">
                    <strong>Teaching Experience</strong><br>
                    <input type="text" name="edit_lecturer_year" placeholder="Eg: 1 Years / 6 Months" required="required" value="<?php echo $row["lecturer_age"]; ?>"><br><br>
                </div>
