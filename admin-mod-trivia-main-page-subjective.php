...
<html>
    ...
    <body>
        ...
        ?>
        <div>
            <p class="mod_title">Trivia Subjective Modify Page</p>
        ...
        <div class="form-container">
            ...
            <div class="form-box" onclick="window.location.href='admin-mod-trivia-ques-subjective.php?id=<?php echo $row['trivia_id'];?>'">
